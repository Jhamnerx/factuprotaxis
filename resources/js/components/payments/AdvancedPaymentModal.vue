<template>
    ...
    >
        ...
        <div class="payment-dialog-content">
            ...
            <div class="mb-4">
                <div class="form-group">
                    <label class="form-label">Meses Seleccionados:</label>
                    <div class="months-container mt-2">
                        <div class="row">
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    <div class="form-group">
                        <label class="form-label">
                            Monto por mes:
                            <small v-if="haveDiscount" class="text-success"
                ...
                <div class="col-md-12 mb-3">
                    <div class="form-group">
                        <label class="form-label">Color de pagos:</label>
...
export default {
    ...
    methods: {
        ...
        initializeWithCalculatedData(data) {
            console.log(
                "Inicialización del modal avanzado con datos calculados:",
                data
            );
