                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div
                                class="form-group"
                                :class="{
                                    'has-danger': errors.token_public_culqui
                                }"
                            >
                                ...
                                <el-input
                                    v-model="form.token_public_culqui"
                                ></el-input>
                                <small
                        ...
                        <div class="col-md-12">
                            <div
                                class="form-group"
                                :class="{
                                    'has-danger': errors.token_private_culqui
                                }"
                            >
                                <label class="control-label"
                                    >Token Privado
                                ...
                                ></label>
                                <el-input
                                    v-model="form.token_private_culqui"
                                ></el-input>
                                <small
                                    class="form-control-feedback"
