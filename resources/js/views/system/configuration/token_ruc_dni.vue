                ...
                <div class="form-body">
                    <div class="row">
                        <div class="col-md-12">
                            <div
                                class="form-group"
                                :class="{ 'has-danger': errors.token_false }"
                            >
                                <el-checkbox v-model="form.token_false"
                                    >Usar consulta interna</el-checkbox
                                ><br />
                                <small
                                    class="form-control-feedback"
                                    v-if="errors.token_false"
                                    v-text="errors.token_false[0]"
                                ></small>
                            </div>
                        </div>
