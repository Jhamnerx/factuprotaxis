<template>
    <div>
        ...
        <div class="card tab-content-default row-new mb-0 pt-2 pt-md-0 mt-4">
                    ...
                    <div class="form-body">
                        ...
                        <div class="row">
                            ...
                            <div
                                ...
                                v-if="
                                    config.enabled_global_igv_to_purchase ===
                                        true
                                "
                            >
                                <div class="form-group">
                        ...
                        >
                            ...
                            <div class="col-md-12">
                                ...
                                <p v-if="form.total_igv > 0" class="text-right">
                                    IGV: {{ currency_type.symbol }}
                                    {{ form.total_igv }}
                                </p>

                                <p v-if="form.total_isc > 0" class="text-right">
                                ...
                                <h3 v-if="form.total > 0" class="text-right">
                                    <b>TOTAL COMPRAS: </b
            ...
            <series-form ref="series_form" @addRowLot="addRowLot">
            </series-form>
