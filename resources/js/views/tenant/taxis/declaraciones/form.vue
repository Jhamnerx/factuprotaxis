        ...
        <form autocomplete="off" @submit.prevent="submit">
            <div class="form-body">
                <div class="row">
                    ...
                    <div class="col-lg-4 col-sm-6 align-self-end">
                        <div
                            :class="{ 'has-danger': errors.propietario }"
                            class="form-group"
                        >
                            <label class="control-label">Propietario</label>
                            <el-input
                                v-model="this.propietarioActual"
                                :disabled="true"
                            ></el-input>
                        </div>
                    </div>
...
export default {
    ...
    data() {
        return {
            ...
            propietarioActual: "No disponible",
            vehiculos: [],
            propietarios: [],
            errors: {}
        };
    ...
    methods: {
                ...
                this.$http
                    ...
                    .then(response => {
                        ...
                        this.propietarioActual =
                            this.form.propietario && this.form.propietario.name
                                ? this.form.propietario.name
                                : "No disponible";
                    });
            }
        },
        ...
        async submit() {
            ...
            if (!this.form.fecha_emision) {
                this.$message.error(
                    "El campo Fecha de Declaración es obligatorio."
                );
                return;
            }
