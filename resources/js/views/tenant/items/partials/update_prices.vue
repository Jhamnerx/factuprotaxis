                        ...
                        <div class="row">
                            ...
                            <div class="col-12 mt-4 mb-2">
                                <a
                                    ...
                                    href="/formats/items_update_prices.xlsx"
                                    target="_new"
                                >
                                    <span class="mr-2"
                                        >Descargar formato de ejemplo para
                                        importar</span
                                    >
            ...
            <el-tab-pane class name="second">
                ...
                <form autocomplete="off">
                    ...
                    <div class="form-actions text-right mt-5">
                        ...
                        <el-button
                            type="primary"
                            @click.prevent="submitPriceEstablishment()"
                            :loading="loading_submit_price"
                            >Procesar</el-button
                        >
                    </div>
                </form>
...
export default {
    ...
    methods: {
        ...
        downloadFormat() {
            window.open(
                `/${this.resource}/prices-establishment-format/export`,
                "_blank"
            );
        }
    }
