                ...
                <div class="form-body">
                                    ...
                                    >
                                        <table class="table">
                                            ...
                                            <tbody>
                                                <tr
                                                    v-for="(row,
                                                    index) in document_affected.items"
                                                    :key="index"
                                                >
                                                    <td>{{ index + 1 }}</td>
                                                    <td>
                    ...
                    <div class="row" v-if="form.items.length > 0">
                        ...
                        <div class="col-md-12">
                            ...
                            <p class="text-right" v-if="form.total_isc > 0">
                                ISC: {{ currency_type.symbol }}
                                {{ form.total_isc }}
                            </p>
                            <p class="text-right" v-if="form.total_charge > 0">
...
export default {
    ...
    methods: {
        ...
        async getNote() {
            ...
            await this.$http
                .get(
                    `/${this.resource}/note/record/${
                        this.form.affected_document_id
                    }`
                )
                .then(response => {
        ...
        getHasDocuments() {
            this.$http
                .get(
                    `/${this.resource}/note/has-documents/${
                        this.form.affected_document_id
                    }`
                )
                .then(response => {
                    if (response.data.success) {
                        ...
                        let message = `<strong>El CPE ${this.document.series}-${
                            this.document.number
                        } ya tiene notas generadas</strong><br/>`;
        ...
        async submit() {
            ...
            if (
                ...
                return this.$message.error(
                    `El monto total de la nota de credito debe ser menor o igual al monto del documento relacionado (${
                        this.document.total
                    })`
                );
            }
