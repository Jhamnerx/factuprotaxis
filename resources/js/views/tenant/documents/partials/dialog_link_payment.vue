    ...
    <div class="pt-2">
        ...
        >
            ...
            >
                <el-tab-pane label="Yape" name="01">
                    <template v-if="payment_configuration.enabled_yape">
                        <div class="row">
                            <div
                                class="col-md-7 col-lg-5 bg-yape text-center pr-0"
                            >
                                <img
                                    src="/logo/yape-logo.png"
                                    class="my-1"
                                ...
                                <div class="card mx-4">
                                    <div class="card-body">
                                        <div class="p-2">
                                            <img
                                                :src="
                                                    payment_configuration.qrcode_yape
                                                "
                                                class="img-fluid"
                                                alt="qr_yape"
                                            />
                                ...
                                <p class="text-white">
                                    {{ payment_configuration.name_yape }}
                                </p>
                                <div class="payment-links-yape">
                                    ...
                                    <template v-else>
                                        <el-button
                                            ...
                                            :loading="loading_generate_link"
                                            >Generar Link</el-button
                                        >
                                    </template>
                                </div>
                                <div
                                    class="m-3"
                                    v-if="
                                        show_input_whatsapp || show_input_email
                                    "
                                >
                                    <template v-if="show_input_whatsapp">
                                        <el-input
                                            v-model="
                                                form_utilities.customer_telephone
                                            "
                                        >
                            ...
                            <div
                                class="col-md-5 col-lg-7 pt-2 d-flex justify-content-center"
                            >
                                <template v-if="has_payment_link">
                                    ...
                                    <img
                                        ...
                                        v-if="form.image_url_uploaded_filename"
                                        :src="form.image_url_uploaded_filename"
                                        alt="Yape"
                                    />
                                </template>
                            </div>
                ...
                <el-tab-pane label="Mercado Pago" name="02">
                    <template v-if="payment_configuration.enabled_mp">
                        <div class="row">
                            <div
                                class="col-md-7 bg-mercadopago text-center pr-0"
                            >
                                <img
                                    src="/logo/logo_mercadopago.jpg"
                                    class="img-fluid"
                                    alt="Yape"
                                />
                                ...
                                <template v-if="has_payment_link">
                                    <template v-if="form.query_transaction">
                                        <div class="row">
                                            ...
                                            >
                                                <h1
                                                    class="display-3 color--success pt-5"
                                                >
                                    ...
                                    <template v-else>
                                        <el-button
                                            type="primary"
                                            @click="clickQueryStatusMP"
                                            >Consultar estado</el-button
                                        >
                                    </template>
                                </template>
                            </div>
            ...
            <div class="row mt-3">
                <div class="col-md-12">
                    <h4 class="text-left">
                        <b>Total a pagar: S/ {{ getPayment() }}</b>
                    </h4>
                </div>
            </div>
        </el-dialog>
...
export default {
    ...
    methods: {
        ...
        clickQueryStatusMP() {
            ...
            this.$http
                .post(`/${this.resource}/query-transaction-state`, {
                    id: this.form.id
                })
                .then(response => {
        ...
        clickSendEmail() {
            if (!this.form_utilities.customer_email)
        ...
        async getData() {
            ...
            await this.$http
                .get(
                    `/${this.resource}/record/${this.form.payment_id}/${
                        this.form.instance_type
                    }/${this.form.payment_link_type_id}`
                )
                .then(response => {
        ...
        async getConfiguration() {
            await this.$http
                .get(`/payment-configurations/record-permissions`)
                .then(response => {
