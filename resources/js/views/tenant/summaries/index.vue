<template>
    <div class="summaries">
        ...
        <div class="card tab-content-default row-new">
            ...
            <div class="card-body">
                <data-table :resource="resource">
                    <tr slot="heading">
                        ...
                        <th class="text-center" v-if="show_summary_status_type">
                            Tipo de estado
                        </th>
                        <th>Identificador</th>
                        <th>Estado</th>
                    ...
                    <tr slot-scope="{ index, row }">
                        ...
                        <td class="text-center" v-if="show_summary_status_type">
                            {{ row.summary_status_type_description }}
                        </td>
            ...
            <summary-regularize
                :showDialog.sync="showDialogRegularize"
                :summary="summary"
            ></summary-regularize>
        </div>
    </div>
