...
export default {
    ...
    setPaymentDestinations(state, payment_destinations) {
        state.payment_destinations =
            payment_destinations === undefined ? [] : payment_destinations;
    },
    setCustomer(state, customer) {
        state.customer = customer === undefined ? {} : customer;
    },
    setParentCustomer(state, parent_customer) {
        state.parent_customer =
            parent_customer === undefined ? {} : parent_customer;
    },
    setChildrenCustomer(state, children_customer) {
        state.children_customer =
            children_customer === undefined ? {} : children_customer;
    },
    ...
    setCustomersAddresses(state, customer_addresses) {
        state.customer_addresses =
            customer_addresses === undefined ? [] : customer_addresses;
    },
    ...
    setCatItemPackageMeasurement(state, CatItemPackageMeasurement) {
        if (CatItemPackageMeasurement === undefined)
    ...
    setPaymentMethodTypes(state, payment_method_types) {
        state.payment_method_types =
            payment_method_types === undefined ? [] : payment_method_types;
    },
    ...
    setExtraCatItemUnitsPerPackage(state, extra_CatItemUnitsPerPackage) {
        if (extra_CatItemUnitsPerPackage === undefined)
    ...
    setExtraCatItemMoldProperty(state, extra_CatItemMoldProperty) {
        if (extra_CatItemMoldProperty === undefined)
    ...
    setExtraCatItemUnitBusiness(state, extra_CatItemUnitBusiness) {
        if (extra_CatItemUnitBusiness === undefined)
    ...
    setExtraCatItemPackageMeasurement(state, extra_CatItemPackageMeasurement) {
        if (extra_CatItemPackageMeasurement === undefined)
    ...
    setExtraCatItemProductFamily(state, extra_CatItemProductFamily) {
        if (extra_CatItemProductFamily === undefined)
    ...
    setItemSearchExtraParameters(state, item_search_extra_parameters) {
        if (item_search_extra_parameters === undefined)
    ...
    setEnabledGlobalIgvToPurchase(state, enabled_global_igv_to_purchase) {
        if (enabled_global_igv_to_purchase === undefined)
    ...
    setCountries(state, countries) {
        state.countries = countries === undefined ? [] : countries;
    },
    setAllDepartments(state, all_departments) {
        state.all_departments =
            all_departments === undefined ? [] : all_departments;
    },
    setAllProvinces(state, all_provinces) {
        state.all_provinces = all_provinces === undefined ? [] : all_provinces;
    },
    setAllDistricts(state, all_districts) {
        state.all_districts = all_districts === undefined ? [] : all_districts;
    },
    setIdentityDocumentTypes(state, identity_document_types) {
        state.identity_document_types =
            identity_document_types === undefined
                ? []
                : identity_document_types;
    },
    setLocations(state, locations) {
        state.locations = locations === undefined ? [] : locations;
    },
    setPersonTypes(state, person_types) {
        state.person_types = person_types === undefined ? [] : person_types;
    },
    setSeries(state, series) {
        state.series = series === undefined ? [] : series;
    },
    setAllSeries(state, all_series) {
        state.all_series = all_series === undefined ? [] : all_series;
    },

    setSellers(state, sellers) {
        state.sellers = sellers === undefined ? [] : sellers;
    },
    setStatusDocumentary(state, statusDocumentary) {
        state.statusDocumentary =
            statusDocumentary === undefined ? [] : statusDocumentary;
    },

    setAllItems(state, all_items) {
        if (state.all_items !== undefined) {
            let temp_item = [state.all_items, ...all_items];
            temp_item = temp_item.filter(
                (item, index, self) =>
