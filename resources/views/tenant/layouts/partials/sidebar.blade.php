                                    ...
                                    @if (in_array('documents', $vc_modules))
                                        @if (in_array('new_document', $vc_module_levels))
                                            <li
                                                ...
                                                <a class="nav-link"
                                                    href="{{ route('tenant.documents.create') }}">Nuevo
                                                    Comprobante</a>
                                            </li>
                                        @endif
                                    @endif
                                ...
                                @if (in_array('documents', $vc_modules) && $vc_company->soap_type_id != '03')
                                    @if (in_array('list_document', $vc_module_levels))
                                        <li
                                            ...
                                            <a class="nav-link" href="{{ route('tenant.documents.index') }}">Listado
                                                de
                                                comprobantes</a>
                                        </li>
                                    @endif
                    ...
                    @if (auth()->user()->type != 'integrator')
                                ...
                                <ul class="nav nav-children">
                                    ...
                                    @if (in_array('clients_types', $vc_module_levels))
                                        <li class="{{ $firstLevel === 'person-types' ? 'nav-active' : '' }}">
                                            <a class="nav-link" href="{{ route('tenant.person_types.index') }}">Tipos
                                                de clientes</a>
                                        </li>
                                    @endif
                        ...
                        <li
                            ...
                            <ul class="nav nav-children">
                                ...
                                <li
                                    ...
                                    <ul class="nav nav-children" style="">
                                        ...
                                        <li
                                            ...
                                            <a class="nav-link" href="{{ route('tenant.taxi.unidades') }}">Listado de
                                                unidades</a>
                                        </li>
                                ...
                                <li class="{{ $firstLevel === 'planes' ? 'nav-active' : '' }}">
                                    <a class="nav-link" href="{{ route('tenant.taxi.planes.index') }}">Planes</a>
                                </li>
                                ...
                                <li class="{{ $firstLevel === 'pagos' ? 'nav-active' : '' }}">
                                    <a class="nav-link" href="{{ route('tenant.taxi.pagos.index') }}">Pagos</a>
                                </li>
                                ...
                                <li class="{{ $firstLevel === 'permisos' ? 'nav-active' : '' }}">
                                    <a class="nav-link" href="{{ route('tenant.taxi.permisos.index') }}">Permiso
                                        de viaje</a>
                                </li>
                                <li class="{{ $firstLevel === 'constancias' ? 'nav-active' : '' }}">
                                    <a class="nav-link"
                                        href="{{ route('tenant.taxi.constancias.index') }}">Constancia de baja</a>
                                </li>
                                ...
                                <ul class="nav nav-children">
                                    ...
                                    @if (in_array('inventory_report', $vc_module_levels))
                                        <li
                                            ...
                                            <a class="nav-link"
                                                href="{{ route('reports.inventory.index') }}">Reporte
                                                Inventario</a>
                                        </li>
                                    @endif
