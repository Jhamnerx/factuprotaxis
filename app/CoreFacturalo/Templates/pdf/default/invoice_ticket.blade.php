...
<body class="ticket">
    ...
    <table class="full-width">
        ...
        @if ($document->retention)
            ...
            <tr>
                <td>
                    <p class="desc">Base imponible de la retención: </p>
                </td>
                <td>
                    <p class="desc">S/ {{ $document->getRetentionTaxBase() }} </p>
                </td>
            </tr>
            <tr>
                <td>
                    <p class="desc">Porcentaje de la retención:</p>
                </td>
                <td>
            ...
            <tr>
                <td>
                    <p class="desc">Monto de la retención:</p>
                </td>
                <td>
