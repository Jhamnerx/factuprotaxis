...
<body>
    ...
    @if ($document->state_type->id == '09')
        <div style="position: absolute; width: 100%; text-align: center; top:30%; left: 0; right: 0; margin: auto;">
            <img src="data:{{ mime_content_type(public_path('status_images' . DIRECTORY_SEPARATOR . 'rechazado.png')) }};base64, {{ base64_encode(file_get_contents(public_path('status_images' . DIRECTORY_SEPARATOR . 'rechazado.png'))) }}"
            ...
            <td width="30%" class="text-center">
                <table class="border-box full-width">
                    ...
                    <tr style="background-color:lightgray">
                        <td class="pt-3 pb-3 font-bold" style="font-size:14px">
                            {{ $document->document_type->description }}</td>
                    </tr>
                    <tr>
    ...
    <table class="full-width mt-1 mb-0">
        <thead class="">
            <tr class="">
                <th class="border-box text-center py-1" width="8%"
                    style="background-color:lightgray; font-size:11px">CANT.</th>
                <th class="border-top-bottom text-center py-2" width="8%"
                    style="background-color:lightgray; font-size:11px">UNIDAD</th>
                <th class="border-top-bottom text-left py-2" style="background-color:lightgray; font-size:11px">
                    DESCRIPCIÓN</th>
                <th class="border-box text-center py-2" width="10%"
                    style="background-color:lightgray; font-size:11px">MODELO</th>
                <th class="border-box text-center py-2" width="8%"
                    style="background-color:lightgray; font-size:11px">LOTE</th>
                <th class="border-box text-center py-2" width="8%"
                    style="background-color:lightgray; font-size:11px">SERIE</th>
                <th class="border-box text-center py-2" width="12%"
                    style="background-color:lightgray; font-size:11px">P.UNIT</th>
                <th class="border-box text-center py-2" width="7%"
                    style="background-color:lightgray; font-size:11px">DTO.</th>
                <th class="border-box text-center py-2" width="12%"
                    style="background-color:lightgray; font-size:11px">TOTAL</th>
            </tr>
        </thead>
        <tbody>
            @foreach ($document->items as $row)
                <tr class= "">
                    ...
                    <td class="text-left align-top" style="border-left:1px solid black">{{ $row->item->model ?? '' }}
                    </td>
                    <td class="text-center align-top" style="border-left:1px solid black">
                    ...
                    @if ($configuration_decimal_quantity->change_decimal_quantity_unit_price_pdf)
                        <td class="text-right align-top" style="border-left:1px solid black">
                    ...
                    <td class="p-0 text-right align-top"
                        style="border-left:1px solid black; border-right:1px solid black;">
            ...
            @elseif($document->retention)
                <tr>
                    <td colspan="8" class="text-right font-bold" style="font-size: 12px;">IMPORTE TOTAL:
                        {{ $document->currency_type->symbol }}</td>
    ...
    <table class="full-width">
        <tr>
                                ...
                                <tr>
                                    ...
                                    <td style="width: 25px;">
                                        ...
                                        <img src="data:{{ mime_content_type($logoPath) }};base64, {{ base64_encode(file_get_contents($logoPath)) }}"
                                            alt="{{ $account->bank->description }}"
                                            style="width: 25px; height: 10px; padding: 1px 0;">
                                    </td>
            ...
            <td width="30%" height="50px" class="text-right">
                <img src="data:image/png;base64, {{ $document->qr }}" style="margin-right: -10px; max-width: 90px"
                    width="16%" />
