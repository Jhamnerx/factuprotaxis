...
<body>
            ...
            <td width="33%" class="text-center">
                <table class="border-box-tuexito py-4 px-2 text-center">
                    ...
                    <tr style="background-color:lightgray">
                        <td class="pt-1 pb-1 pl-4 pr-4 font-bold" style="font-size:16px">
    ...
    <table class="full-width mt-10 mb-10 ">
        <thead class="">
            <tr class="">
                <th class="border-box-tuexito text-center py-2" width="8%" style="background-color:lightgray">
                    CANT.</th>
                <th class="border-box-tuexito text-center py-2" width="9%" style="background-color:lightgray">
                    UNIDAD</th>
                <th class="border-box-tuexito text-center py-2" width="9%" style="background-color:lightgray">
                    CÓDIGO</th>
                <th class="border-box-tuexito text-left py-2" width="47%" style="background-color:lightgray">
                    DESCRIPCIÓN</th>
                <th class="border-box-tuexito text-center py-2" width="10%" style="background-color:lightgray">
                    P.UNIT</th>
                <th class="border-box-tuexito text-center py-2" width="7%" style="background-color:lightgray">
                    DTO.</th>
                <th class="border-box-tuexito text-center py-2" width="10%" style="background-color:lightgray">
                    TOTAL</th>
            </tr>
        ...
        <tbody>
            ...
            @foreach ($document->items as $key => $row)
                ...
                @endif --}}
                    ...
                    <td class="p-0 text-right align-top border-left border-right">{{ number_format($row->total, 2) }}
                    </td>
                </tr>
            ...
            @elseif($document->retention)
                <tr>
                    <td colspan="6" class="text-right font-bold" style="font-size: 12px;">IMPORTE TOTAL:
                        {{ $document->currency_type->symbol }}</td>
                    ...
                    @if ($document->detraction)
                        <tr class="border-box-tuexito">
                            ...
                            Operación sujeta al Sistema de Pago de Obligaciones Tributarias
                                ...
                                <table class="full-width">
                                    <tr>
                                        <td class="text-uppercase font-bold" style="font-size:11px">OPERACIÓN SUJETA A
                                            DETRACCIÓN</td>
                                    </tr>
                                </table>
                                <table class="full-width">
                                ...
                                <table class="full-width">
                                    <tr>
                                        ...
                                        <td width="220px" style="font-size:11px">
                                            {{ $document->detraction->detraction_type_id }}
                                            -
    ...
    <table class="full-width">
        @foreach ($document->additional_information as $information)
            @if ($information)
                @if ($loop->first)
                    <tr>
                        <td class="fs-11" width="75px"><strong>Observaciones</strong></td>
                    </tr>
                    <tr>
                        <td class="fs-11">{{ $information }}</td>
                    </tr>
                @endif
