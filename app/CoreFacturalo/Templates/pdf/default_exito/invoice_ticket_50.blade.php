...
<body>
    ...
    <table class="full-width">
        ...
        <tr>
            <td class="ticket-50 text-center pb-2 border-bottom">
    ...
    <table class="full-width">
        ...
        @if ($document->retention)
            ...
            <tr>
                <td>
                    <p class="desc-ticket text-uppercase">Base imponible de la retención: </p>
                </td>
                <td>
            ...
            <tr>
                <td>
                    <p class="desc-ticket text-uppercase">Porcentaje de la retención:</p>
                </td>
                <td>
            ...
            <tr>
                <td>
                    <p class="desc-ticket text-uppercase">Monto de la retención:</p>
                </td>
                <td>
            ...
            @if ($row->code == '1000')
                <td class="desc-ticket text-uppercase">
                    <div style="font-size: 10px;">
                        Son: <span class="text-uppercase">{{ $row->value }}
    ...
    @else
        ...
        <tr>
            <td class="ticket-50 text-center desc text-uppercase border-bottom">Código Hash: {{ $document->hash }}
            </td>
        </tr>
        ...
        <tr>
            <td class="text-center desc-9 pt-2">
                ...
                <br>
                Representacion impresa de la <span style="text-transform: capitalize"
                    class="text-capitalize">{{ $document->document_type->description }}</span>
            </td>
        </tr>
    </table>
