...
<body>
    @if ($document->state_type->id == '11')
        <div class="company_logo_box" style="position: absolute; text-align: center; top:30%;">
            <img src="data:{{ mime_content_type(public_path('status_images' . DIRECTORY_SEPARATOR . 'rechazado.png')) }};base64, {{ base64_encode(file_get_contents(public_path('status_images' . DIRECTORY_SEPARATOR . 'anulado.png'))) }}"
        ...
        <tr>
            ...
            <td width="50%" class="pl-3">
                <div class="text-left">
                    ...
                    <h6>{{ $establishment->email && $establishment->email !== '-' ? 'Email: ' . $establishment->email : '' }}
                    </h6>
