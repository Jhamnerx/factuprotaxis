                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="space-y-4">
                                ...
                                <div class="flex justify-between py-2 border-b border-gray-100 dark:border-gray-700">
                                    ...
                                    <span
                                        class="text-sm text-gray-900 dark:text-white">{{ $vehiculo->marca->nombre ?? 'N/A' }}</span>
                                </div>
                                <div class="flex justify-between py-2 border-b border-gray-100 dark:border-gray-700">
                                    <span class="text-sm font-medium text-gray-700 dark:text-gray-300">Modelo:</span>
                                    <span
                                        class="text-sm text-gray-900 dark:text-white">{{ $vehiculo->modelo->nombre ?? 'N/A' }}</span>
                                </div>
                            </div>
                            <div class="space-y-4">
                                <div class="flex justify-between py-2 border-b border-gray-100 dark:border-gray-700">
                                    ...
                                    <span
                                        class="text-sm text-gray-900 dark:text-white">{{ $vehiculo->year ?? 'N/A' }}</span>
                                </div>
                                <div class="flex justify-between py-2 border-b border-gray-100 dark:border-gray-700">
