    ...
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        ...
        <div class="sm:flex sm:justify-between sm:items-center mb-8">
            ...
            <div class="mb-4 sm:mb-0">
                ...
                <div class="flex items-center space-x-4">
                    <p class="text-gray-600 dark:text-gray-400">Gestiona los permisos de tu vehículo: {{ $vehiculo->placa }}
                    </p>
                    <span
                        ...
                        @if (request()->hasAny(['estado', 'tipo_permiso', 'search']))
        ...
        <div class="mb-8">
            <div class="bg-white dark:bg-gray-800 shadow-sm rounded-xl p-6">
                <form method="GET" action="{{ route('taxis.conductor.permisos') }}" id="filterForm">
                    ...
                    <div class="flex items-center space-x-2 mt-4">
                        ...
                        @if (request()->hasAny(['search', 'estado', 'tipo_permiso']))
                    ...
                    <div
                        ...
                        <div class="bg-gray-50 dark:bg-gray-700/50 rounded-lg p-4 mb-4">
                            <div class="flex items-center justify-between mb-2">
                                ...
                                <span
                                    class="text-sm font-bold text-gray-900 dark:text-gray-100">{{ $vehiculo->placa }}</span>
                            </div>
                        ...
                        <div class="space-y-3 mb-6">
                            ...
                            @if ($permiso->observaciones)
                                <div>
                                    ...
                                    <p class="text-sm text-gray-900 dark:text-gray-100 mt-1">{{ $permiso->observaciones }}
                                    </p>
                                </div>
                            @endif
                            ...
                            <div
                                ...
                                <span>Emitido:
                                    @if (is_array($permiso->created_at))
                                        {{ \Carbon\Carbon::parse($permiso->created_at['date'] ?? ($permiso->created_at[0] ?? now()))->format('d/m/Y H:i') }}
                                    @else
                                        {{ \Carbon\Carbon::parse($permiso->created_at)->format('d/m/Y H:i') }}
                                    @endif
                                </span>
                                @if ($permiso->creator)
                        ...
                        <div class="flex space-x-2">
                            <a href="{{ route('taxis.conductor.pdf.permiso', $permiso->id) }}" target="_blank"
            ...
            <div class="bg-white dark:bg-gray-800 shadow-sm rounded-xl p-8 text-center">
                <div class="max-w-md mx-auto">
                    ...
                    @else
                        ...
                        <p class="text-gray-500 dark:text-gray-400 mb-6">
                            Aún no tienes permisos registrados para tu vehículo.
                        </p>
                    @endif
                </div>
            </div>
