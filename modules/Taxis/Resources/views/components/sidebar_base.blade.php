    ...
    <div id="sidebar"
        ...
        <div class="space-y-8">
            ...
            <div>
                ...
                <ul class="mt-3">
                    <!-- Dashboard -->
                    <li class="pl-4 pr-3 py-2 rounded-lg mb-0.5 last:mb-0 bg-linear-to-r from-violet-500/[0.12] dark:from-violet-500/[0.24] to-violet-500/[0.04]"
                        x-data="{ open: true }">
                        ...
                        <div class="lg:hidden lg:sidebar-expanded:block 2xl:block">
                            <ul class="pl-8 mt-1" :class="open ? 'block!' : 'hidden'">
                                ...
                                <li class="mb-1 last:mb-0">
                                    <a class="block text-violet-500 transition truncate" href="analytics.html">
                                        <span
                        ...
                        <a class="block text-gray-800 dark:text-gray-100 hover:text-gray-900 dark:hover:text-white truncate transition"
                            ...
                            <div class="flex items-center justify-between">
                                ...
                                <div class="flex shrink-0 ml-2">
                                    <span
                                        class="inline-flex items-center justify-center h-5 text-xs font-medium text-white bg-violet-400 px-2 rounded-sm">4</span>
                                </div>
                            </div>
                        </a>
                    </li>
