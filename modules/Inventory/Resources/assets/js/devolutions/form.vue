                        ...
                        <div class="row mt-1">
                            <div class="col-lg-4 pb-2">
                                ...
                                >
                                    ...
                                    <el-select
                                        v-model="form.devolution_reason_id"
                                        filterable
                                        class="border-left rounded-left border-info"
                                        popper-class="el-select-customers"
                                    >
                                        <el-option
                                            v-for="option in devolution_reasons"
                                            :key="option.id"
                                            :value="option.id"
                                    ...
                                    <small
                                        ...
                                        v-if="errors.devolution_reason_id"
                                        v-text="errors.devolution_reason_id[0]"
                                    ></small>
                                </div>
                            </div>
                            <div class="col-lg-2">
