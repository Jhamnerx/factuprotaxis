...
class TenancyDatabaseSeeder extends Seeder
{
    ...
    private function obtenerYGuardarModelos()
    {
        ...
        $plans = [
            [
                'id' => 4,
                'name' => json_encode(['es' => 'CLASICO']),
                'slug' => 'clasico',
                'description' => json_encode(['es' => null]),
                'is_active' => 1,
                'price' => 30.00,
                'signup_fee' => 0.00,
                'currency' => 'PEN',
                ...
                'sort_order' => 1,
                'is_socio' => 0,
                'discounts' => '[{"name":"Descuento por pago anual","slug":"descuento-anual","value":160,"months":12},{"name":"Descuento por pago semestral","slug":"descuento-semestral","value":0,"months":6},{"name":"Descuento por pago trimestral","slug":"descuento-trimestral","value":30,"months":3},{"name":"Descuento por inicio de mes","slug":"descuento-inicio-mes","value":5,"months":1}]',
            ...
            [
                ...
                'sort_order' => 3,
                'is_socio' => 1,
                'discounts' => '[{"name":"Descuento por pago anual","slug":"descuento-anual","value":0,"months":12},{"name":"Descuento por pago semestral","slug":"descuento-semestral","value":0,"months":6},{"name":"Descuento por pago trimestral","slug":"descuento-trimestral","value":0,"months":3},{"name":"Descuento por inicio de mes","slug":"descuento-inicio-mes","value":0,"months":1}]',
