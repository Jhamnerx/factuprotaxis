...
class CreateSubscriptionInvoicesTable extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('subscription_invoices', function (Blueprint $table) {
            ...
            $table->decimal('monto', 11, 4)->nullable();
            $table->date('fecha_cobro')->nullable();
            $table->integer('mes')->nullable(); // mes de la factura
            $table->integer('year')->nullable(); // año de la factura
            ...
            $table->foreign('vehiculo_id')->nullable()
                ->references('id')
                ->on('vehiculos')
                ->onDelete('cascade');
